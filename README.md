...
### 团队成员
- **算法开发**：深度学习模型设计、训练与部署 lidonghao
- **嵌入式开发**：RISC-V平台适配与优化 shuxingyan
- **系统集成**：蓝牙通信与整体测试 zhanghan

## 参考文档

- [决赛赛题要求](决赛赛题要求.md)
- [完整设计文档](VESC2025设计文档-西部赛区-电子科技大学-自动化摸鱼队(2).pdf)
- [决赛官网](https://vesc.verisilicon.com/home/winners)
